...
from .config import AIRLINE_IMAGE_DIR, AIRLINE_UPLOAD_DIR, APP_NAME, DATA_DIR, DEBUG, SECRET_KEY, SESSION_COOKIE, SESSION_HTTPS_ONLY, STATIC_DIR
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        logger.info("Inicialização concluída. Migração: %s | viagens recuperadas: %s | proprietários ajustados: %s", migration, trip_backfill, owners_fixed)
    finally:
        db.close()
    yield
